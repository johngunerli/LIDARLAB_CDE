...
def estimate_distance(image_width, landmark1, landmark2):
    ...
    pixel_distance = ((landmark1.x - landmark2.x) ** 2 +
                      (landmark1.y - landmark2.y) ** 2) ** 0.5 * image_width
...
max_measurements = 25  # Maximum number of measurements
...
# For MP4 file, using H.264 codec
...
while cap.isOpened() and measurement_count < max_measurements:
    ...
    if results.pose_landmarks:
        ...
        cv2.putText(image, f"Distance: {distance:.2f} cm", (10, 30),
